...
var
  ...
  PascalProperties_Isxclasses: array of AnsiString = [
    ...
    'DirBrowseButton', 'DirEdit', 'DiskSpaceLabel', 'DropDownCount', 'DroppedDown', 'Duplicates',
    'Edits', 'ElevationRequired', 'Empty', 'Enabled', 'FilenameLabel', 'FinishedHeadingLabel',
    'FinishedLabel', 'FinishedPage', 'Flat', 'FlipControlsOnShow', 'FocusControl', 'Font',
    'ForceLTRReading', 'FormStyle', 'GetExtraClientHeight', 'GetExtraClientWidth', 'GroupBrowseButton',
    'GroupEdit', 'Handle', 'Height', 'HideSelection', 'Hint', 'ID', 'InfoAfterClickLabel',
    'InfoAfterMemo', 'InfoAfterPage', 'InfoBeforeClickLabel', 'InfoBeforeMemo', 'InfoBeforePage',
    'InnerNotebook', 'InnerPage', 'InstallingPage', 'IsSaveButton', 'ItemCaption', 'ItemEnabled',
    'ItemFontStyle', 'ItemIndex', 'ItemLevel', 'ItemObject', 'Items', 'ItemSubItem', 'KeepSizeX',
    'KeepSizeY', 'KeyPreview', 'LastBaseNameOrUrl', 'Left', 'LicenseAcceptedRadio', 'LicenseLabel1',
    'LicenseMemo', 'LicenseNotAcceptedRadio', 'LicensePage', 'Lines', 'MainPanel', 'Max',
    'MaxHeight', 'MaxLength', 'MaxWidth', 'Min', 'MinHeight', 'MinItemHeight', 'MinWidth',
    'ModalResult', 'Mode', 'Modified', 'Msg1Label', 'Msg2Label', 'MsgLabel', 'MultiSelect',
    'Name', 'NewFolderName', 'NextButton', 'NoIconsCheck', 'NoRadio', 'Notebook', 'Objects',
    'Offset', 'OnActivate', 'OnBackButtonClick', 'OnCancelButtonClick', 'OnChange', 'OnChanging',
    'OnClick', 'OnClickCheck', 'OnClose', 'OnCloseQuery', 'OnCreate', 'OnDblClick', 'OnDeactivate',
    'OnDestroy', 'OnDropDown', 'OnHide', 'OnKeyDown', 'OnKeyPress', 'OnKeyUp', 'OnLinkClick',
    'OnNextButtonClick', 'OnRename', 'OnResize', 'OnShouldSkipPage', 'OnShow', 'OuterNotebook',
    'Owner', 'PageCount', 'PageDescriptionLabel', 'PageIndex', 'PageNameLabel', 'Pages',
    'Parent', 'ParentBackground', 'Password', 'PasswordChar', 'PasswordEdit', 'PasswordEditLabel',
    'PasswordLabel', 'PasswordPage', 'Pen', 'Pitch', 'Pixels', 'PixelsPerInch', 'PngImage',
    'PopupMode', 'PopupParent', 'Position', 'PreparingErrorBitmapImage', 'PreparingLabel',
