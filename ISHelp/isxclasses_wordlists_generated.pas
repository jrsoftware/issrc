...
var
  ...
  PascalTypes_Isxclasses: array of AnsiString = [
    ...
    'TColor', 'TComboBox', 'TComboBoxStyle', 'TComponent', 'TComponentState', 'TComponentStateE',
    'TConstraintSize', 'TControl', 'TCopyMode', 'TCursor', 'TCustomCheckBox', 'TCustomComboBox',
    ...
    'TFolderTreeView', 'TFont', 'TFontPitch', 'TFontStyle', 'TFontStyles', 'TForm', 'TFormBorderStyle',
    'TFormStyle', 'TGraphic', 'TGraphicControl', 'TGraphicsObject', 'THandle', 'THandleStream',
    'TInputDirWizardPage', 'TInputFileWizardPage', 'TInputOptionWizardPage', 'TInputQueryWizardPage',
    ...
    'TNewLinkLabel', 'TNewListBox', 'TNewMemo', 'TNewNotebook', 'TNewNotebookPage', 'TNewPathEdit',
  ...
  PascalEnumValues_Isxclasses: array of AnsiString = [
    ...
    'bsPushButton', 'bsCommandLink', 'bsSplitButton',
  ...
  PascalMembers_Isxclasses: TScriptTable = [
    ...
    'function Add(ArchiveFileName, DestDir: String; FullPaths: Boolean): NativeInt;',
    'function Add(S: String): Integer;',
    'function Add(Url, BaseName, RequiredSHA256OfFile: String): NativeInt;',
    ...
    'function AddEx(ArchiveFileName, DestDir, Password: String; FullPaths: Boolean): NativeInt;',
    'function AddEx(Url, BaseName, RequiredSHA256OfFile, UserName, Password: String): NativeInt;',
    'function AddExWithISSigVerify(Url, ISSigUrl, BaseName, UserName, Password: String; AllowedKeysRuntimeIDs: TStringList): NativeInt;',
    ...
    'function AddWithISSigVerify(Url, ISSigUrl, BaseName: String; AllowedKeysRuntimeIDs: TStringList): NativeInt;',
    ...
    'procedure FlipAndCenterIfNeeded(ACenterInsideControl: Boolean; CenterInsideControlCtl: TWinControl; CenterInsideControlInsideClientArea: Boolean);',
  ...
  PascalProperties_Isxclasses: array of AnsiString = [
    ...
    'DirBrowseButton', 'Directory', 'DirEdit', 'DiskSpaceLabel', 'DropDownCount', 'DroppedDown',
    'Duplicates', 'Edits', 'ElevationRequired', 'Empty', 'Enabled', 'ExtraClientHeight',
    'ExtraClientWidth', 'FilenameLabel', 'FinishedHeadingLabel', 'FinishedLabel', 'FinishedPage',
    'Flat', 'FlipControlsOnShow', 'FocusControl', 'Font', 'ForceLTRReading', 'FormStyle',
    'GroupBrowseButton', 'GroupEdit', 'Handle', 'Height', 'HideSelection', 'Hint', 'ID',
    'InfoAfterClickLabel', 'InfoAfterMemo', 'InfoAfterPage', 'InfoBeforeClickLabel', 'InfoBeforeMemo',
    'InfoBeforePage', 'InnerNotebook', 'InnerPage', 'InstallingPage', 'IsSaveButton', 'ItemCaption',
    'ItemEnabled', 'ItemFontStyle', 'ItemIndex', 'ItemLevel', 'ItemObject', 'Items', 'ItemSubItem',
    'KeepSizeX', 'KeepSizeY', 'KeyPreview', 'LastBaseNameOrUrl', 'Left', 'LicenseAcceptedRadio',
    'LicenseLabel1', 'LicenseMemo', 'LicenseNotAcceptedRadio', 'LicensePage', 'Lines',
    'MainPanel', 'Max', 'MaxHeight', 'MaxLength', 'MaxWidth', 'Min', 'MinHeight', 'MinItemHeight',
    'MinWidth', 'ModalResult', 'Mode', 'Modified', 'Msg1Label', 'Msg2Label', 'MsgLabel',
    'MultiSelect', 'Name', 'NewFolderName', 'NextButton', 'NoIconsCheck', 'NoRadio', 'Notebook',
    'Objects', 'Offset', 'OnActivate', 'OnBackButtonClick', 'OnCancelButtonClick', 'OnChange',
    'OnChanging', 'OnClick', 'OnClickCheck', 'OnClose', 'OnCloseQuery', 'OnCreate', 'OnDblClick',
    'OnDeactivate', 'OnDestroy', 'OnDropDown', 'OnHide', 'OnKeyDown', 'OnKeyPress', 'OnKeyUp',
    'OnLinkClick', 'OnNextButtonClick', 'OnRename', 'OnResize', 'OnShouldSkipPage', 'OnShow',
    'OuterNotebook', 'Owner', 'PageCount', 'PageDescriptionLabel', 'PageIndex', 'PageNameLabel',
    'Pages', 'Parent', 'ParentBackground', 'Password', 'PasswordChar', 'PasswordEdit',
    'PasswordEditLabel', 'PasswordLabel', 'PasswordPage', 'Pen', 'Pitch', 'Pixels', 'PixelsPerInch',
    'PngImage', 'PopupMode', 'PopupParent', 'Position', 'PreparingErrorBitmapImage', 'PreparingLabel',
    ...
    'ShowBaseNameInsteadOfUrl', 'ShowHint', 'Showing', 'ShowLines', 'Size', 'Sorted', 'State',
    'StatusLabel', 'Stretch', 'Strings', 'Style', 'StyleElements', 'StyleName', 'SubCaptionLabel',
    'SubItemFontStyle', 'Surface', 'SurfaceColor', 'SurfaceExtraHeight', 'SurfaceExtraWidth',
    'SurfaceHeight', 'SurfaceWidth', 'TabOrder', 'TabStop', 'Tag', 'TasksList', 'Text',
    'Top', 'TypesCombo', 'UseRichEdit', 'UserInfoNameEdit', 'UserInfoNameLabel', 'UserInfoOrgEdit',
    'UserInfoOrgLabel', 'UserInfoPage', 'UserInfoSerialEdit', 'UserInfoSerialLabel', 'UseVisualStyle',
    'Values', 'Visible', 'WantReturns', 'WantTabs', 'WelcomeLabel1', 'WelcomeLabel2', 'WelcomePage',
