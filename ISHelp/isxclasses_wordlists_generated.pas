...
var
  ...
  PascalProperties_Isxclasses: array of AnsiString = [
    ...
    'Brush', 'Buttons', 'Cancel', 'CancelButton', 'Canvas', 'Caption', 'CaseSensitive',
    'Center', 'CenterOnShow', 'CharCase', 'Checked', 'CheckListBox', 'ClientHeight', 'ClientWidth',
    'Color', 'CommandLinkHint', 'CommaText', 'ComponentCount', 'ComponentIndex', 'Components',
    'ComponentsDiskSpaceLabel', 'ComponentsList', 'ComponentState', 'Constraints', 'ControlCount',
    'Controls', 'ControlsFlipped', 'CopyMode', 'Count', 'CurPageID', 'Cursor', 'Default',
    'Description', 'DesignInfo', 'DirBrowseButton', 'Directory', 'DirEdit', 'DiskSpaceLabel',
    'DropDownCount', 'DroppedDown', 'Duplicates', 'Edits', 'ElevationRequired', 'Empty',
    'Enabled', 'ExtraClientHeight', 'ExtraClientWidth', 'FilenameLabel', 'FinishedHeadingLabel',
    'FinishedLabel', 'FinishedPage', 'Flat', 'FlipControlsOnShow', 'FocusControl', 'Font',
    'ForceLTRReading', 'FormStyle', 'GroupBrowseButton', 'GroupEdit', 'Handle', 'Height',
    'HideSelection', 'Hint', 'ID', 'InfoAfterClickLabel', 'InfoAfterMemo', 'InfoAfterPage',
    'InfoBeforeClickLabel', 'InfoBeforeMemo', 'InfoBeforePage', 'InnerNotebook', 'InnerPage',
    'InstallingPage', 'IsSaveButton', 'ItemCaption', 'ItemEnabled', 'ItemFontStyle', 'ItemIndex',
    'ItemLevel', 'ItemObject', 'Items', 'ItemSubItem', 'KeepSizeX', 'KeepSizeY', 'KeyPreview',
