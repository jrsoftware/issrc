...
var
  ...
  PascalProperties_Isxclasses: array of AnsiString = [
    ...
    'Brush', 'Buttons', 'Cancel', 'CancelButton', 'Canvas', 'Capacity', 'Caption', 'CaseSensitive',
    ...
    'DelimitedText', 'Delimiter', 'Description', 'DesignInfo', 'DirBrowseButton', 'Directory',
    'DirEdit', 'DiskSpaceLabel', 'DropDownCount', 'DroppedDown', 'Duplicates', 'Edits',
    'ElevationRequired', 'Empty', 'Enabled', 'ExtraClientHeight', 'ExtraClientWidth', 'FilenameLabel',
    ...
    'ItemIndex', 'ItemLevel', 'ItemObject', 'Items', 'ItemSubItem', 'KeepSizeX', 'KeepSizeY',
    'KeyPreview', 'LastBaseNameOrUrl', 'Left', 'LicenseAcceptedRadio', 'LicenseLabel1',
    ...
    'Name', 'NameValueSeparator', 'NewFolderName', 'NextButton', 'NoIconsCheck', 'NoRadio',
    ...
    'Pixels', 'PixelsPerInch', 'PngImage', 'PopupMode', 'PopupParent', 'Position', 'PreparingErrorBitmapImage',
    'PreparingLabel', 'PreparingMemo', 'PreparingNoRadio', 'PreparingPage', 'PreparingYesRadio',
    'PrevAppDir', 'ProgressBar', 'ProgressGauge', 'PromptLabels', 'QuoteChar', 'ReadOnly',
    ...
    'StatusLabel', 'Stretch', 'StrictDelimiter', 'Strings', 'Style', 'StyleElements', 'StyleName',
    'SubCaptionLabel', 'SubItemFontStyle', 'Surface', 'SurfaceColor', 'SurfaceExtraHeight',
    'SurfaceExtraWidth', 'SurfaceHeight', 'SurfaceWidth', 'TabOrder', 'TabStop', 'Tag',
    'TasksList', 'Text', 'Top', 'Transparent', 'TypesCombo', 'UseRichEdit', 'UserInfoNameEdit',
