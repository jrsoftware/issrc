...
var
  ...
  PascalProperties_Isxclasses: array of AnsiString = [
    ...
    'ClientHeight', 'ClientWidth', 'Color', 'CommandLinkHint', 'CommaText', 'ComponentCount',
    'ComponentIndex', 'Components', 'ComponentsDiskSpaceLabel', 'ComponentsList', 'ComponentState',
    'Constraints', 'ControlCount', 'Controls', 'ControlsFlipped', 'CopyMode', 'Count',
    'CurPageID', 'Cursor', 'Default', 'Description', 'DesignInfo', 'DirBrowseButton', 'DirEdit',
    'DiskSpaceLabel', 'DropDownCount', 'DroppedDown', 'Duplicates', 'Edits', 'ElevationRequired',
    'Empty', 'Enabled', 'FilenameLabel', 'FinishedHeadingLabel', 'FinishedLabel', 'FinishedPage',
