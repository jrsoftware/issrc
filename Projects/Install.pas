...
uses
  ...
  Wizard, DebugStruct, DebugClient, VerInfo, ScriptRunner, RegDLL, Helper, WebDownloader,
    ...
    try
      ...
      try
        ...
        if SetupHeader.AppVerName <> '' then
          Downloader.Agent := 'InnoSetup - ' + SetupHeader.AppVerName
        else
          Downloader.Agent := 'InnoSetup';
