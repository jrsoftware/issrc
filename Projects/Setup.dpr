...
uses
  ...
  Setup.Main in 'Src\Setup\Setup.Main.pas' {MainForm},
  ...
  Setup.Undo in 'Src\Setup\Setup.Undo.pas',
  Struct in 'Src\Struct.pas',
  Setup.NewDisk in 'Src\Setup\Setup.NewDisk.pas' {NewDiskForm},
  ...
  Setup.Wizard in 'Src\Setup\Setup.Wizard.pas' {WizardForm},
  Setup.ScriptFunc_R in 'Src\Setup\Setup.ScriptFunc_R.pas',
  ...
  Setup.ScriptClasses_R in 'Src\Setup\Setup.ScriptClasses_R.pas',
  Setup.SelLangForm in 'Src\Setup\Setup.SelLangForm.pas' {SelectLanguageForm},
  Setup.Extract in 'Src\Setup\Setup.Extract.pas',
  Int64Em in 'Src\Int64Em.pas',
  Setup.SelFolderForm in 'Src\Setup\Setup.SelFolderForm.pas' {SelectFolderForm},
  Compress in 'Src\Compress.pas',
  CompressZlib in 'Src\CompressZlib.pas',
  bzlib in 'Src\bzlib.pas',
  Setup.LZMADecomp in 'Src\Setup\Setup.LZMADecomp.pas',
  FileClass in 'Src\FileClass.pas',
  MD5 in '..\Components\MD5.pas',
  SHA1 in '..\Components\SHA1.pas',
  Setup.Logging in 'Src\Setup\Setup.Logging.pas',
  ...
  Setup.UninstProgressForm in 'Src\Setup\Setup.UninstProgressForm.pas' {UninstProgressForm},
  Setup.UninstSharedFileForm in 'Src\Setup\Setup.UninstSharedFileForm.pas' {UninstSharedFileForm},
  ...
  Setup.DotNet in 'Src\Setup\Setup.DotNet.pas',
  SetupEnt in 'Src\SetupEnt.pas',
  Setup.Msi in 'Src\Setup\Setup.Msi.pas',
