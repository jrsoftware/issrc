...
uses
   Windows, Classes, SHA256, Shared.FileClass, Shared.SetupTypes, Shared.Struct;
...
uses
  Messages, ShlObj, RegStr, SysUtils, Forms,
  ISSigFunc, NewProgressBar, PathFunc, RestartManager, TaskbarProgressFunc,
  Shared.CommonFunc, Shared.CommonFunc.Vcl, Shared.Int64Em, Shared.SetupMessageIDs, Shared.VerInfoFunc,
  ...
  Setup.DebugClient, Setup.DotNetFunc, Setup.DownloadFileFunc, Setup.FileExtractor, Setup.Helper,
  Setup.InstFunc, Setup.InstFunc.Ole, Setup.MainFunc, Setup.LoggingFunc, Setup.RegDLL,
  Setup.ScriptRunner, Setup.SecurityFunc, Setup.UninstallLog, Setup.WizardForm;
