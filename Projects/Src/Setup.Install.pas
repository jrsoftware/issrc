...
uses
  ...
  ISSigFunc, NewProgressBar, PathFunc, RestartManager, SHA256, TaskbarProgressFunc,
  ...
  Setup.DebugClient, Setup.DotNetFunc, Setup.DownloadFileFunc, Setup.ISSigVerifyFunc,
  Setup.FileExtractor, Setup.Helper, Setup.InstFunc, Setup.InstFunc.Ole, Setup.MainFunc,
  Setup.LoggingFunc, Setup.RegDLL, Setup.ScriptRunner, Setup.SecurityFunc, Setup.UninstallLog,
  Setup.WizardForm;
