...
const
  ...
  SInspectorNothingToInspectNote = 'Move to a key/value or [Code] section, or a parameter entry';
  ...
  SOptionsLanguageChangeRestart = 'The new language will take effect the next time you start Inno Setup Compiler.';
