...
const
  ...
  SWizardScriptCommentUniqueAppId = 'NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.';
  SWizardScriptCommentGenerateGuid = '(To generate a new GUID, click Tools | Generate GUID inside the IDE.)';
  SWizardScriptCommentArchitecturesAllowed1 = '"ArchitecturesAllowed=x64compatible" specifies that Setup cannot run';
  SWizardScriptCommentArchitecturesAllowed2 = 'on anything but x64 and Windows 11 on Arm.';
  SWizardScriptCommentArchitecturesAllowed3 = '';
  SWizardScriptCommentArchitecturesInstallIn64BitMode1 = '"ArchitecturesInstallIn64BitMode=x64compatible" requests that the';
  SWizardScriptCommentArchitecturesInstallIn64BitMode2 = 'install be done in "64-bit mode" on x64 or Windows 11 on Arm,';
  SWizardScriptCommentArchitecturesInstallIn64BitMode3 = 'meaning it should use the native 64-bit Program Files directory and';
  SWizardScriptCommentArchitecturesInstallIn64BitMode4 = 'the 64-bit view of the registry.';
  SWizardScriptCommentChangeTo64BitInstaller = 'Uncomment the following line to use a 64-bit installer.';
  SWizardScriptCommentArchiveExtractionEnhanced = 'Use "ArchiveExtraction=enhanced" if all your archives are .7z files.';
  SWizardScriptCommentArchiveExtractionEnhancedNoPassword = 'Use "ArchiveExtraction=enhanced/nopassword" if all your archives are not password-protected.';
