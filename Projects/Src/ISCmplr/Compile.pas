...
begin
  ...
  case Directive of
    ...
    ssLZMADictionarySize: begin
        var MaxDictionarySize := 1024 shl 20; //1 GB - same as MaxDictionarySize in LZMADecomp.pas - lower than the LZMA SDK allows (search Lzma2Enc.c for kLzmaMaxHistorySize to see this limit: 15 shl 28 = 3.8 GB) because Setup can't allocate that much memory
