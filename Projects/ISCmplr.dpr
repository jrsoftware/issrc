...
uses
  ...
  ISCmplr.Compile in 'Src\ISCmplr\ISCmplr.Compile.pas',
  ISCmplr.Messages in 'Src\ISCmplr\ISCmplr.Messages.pas',
  Shared.Struct in 'Src\Shared.Struct.pas',
  Shared.ScriptFunc in 'Src\Shared.ScriptFunc.pas',
  ISCmplr.ScriptFunc in 'Src\ISCmplr\ISCmplr.ScriptFunc.pas',
  ISCmplr.ScriptCompiler in 'Src\ISCmplr\ISCmplr.ScriptCompiler.pas',
  ISCmplr.ScriptClasses in 'Src\ISCmplr\ISCmplr.ScriptClasses.pas',
  Shared.ResUpdate in 'Src\Shared.ResUpdate.pas',
  ISCmplr.ExeUpdate in 'Src\ISCmplr\ISCmplr.ExeUpdate.pas',
  ...
  ISCmplr.LZMACompressor in 'Src\ISCmplr\ISCmplr.LZMACompressor.pas',
