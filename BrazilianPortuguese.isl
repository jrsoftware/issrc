; *** Inno Setup version 6.1.0+ Brazilian Portuguese messages made by Felipe felipefplzx@gmail.com ***
;
...
StopDownload=Você tem certeza que você quer parar o download?
ErrorDownloadAborted=Download abortado
ErrorDownloadFailed=O download falhou: %1 %2
ErrorDownloadSizeFailed=Falhou em obter o tamanho: %1 %2
ErrorFileHash1=Falhou em obter o hash do arquivo: %1
ErrorFileHash2=Hash do arquivo inválido: esperado %1, achado %2
ErrorProgress=Progresso inválido: %1 de %2
ErrorFileSize=Tamanho do arquivo inválido: esperado %1, achado %2
...
PrepareToInstallNeedsRestart=O instalador deve reiniciar seu computador. Após reiniciar seu computdor executar o instalador de novo pra completar a instalação do [name].%n%nVocê gostaria de reinciar agora?
...
FileExistsOverwriteOrKeepAll=&Fazer isto nos próximos conflitos
ExistingFileNewerSelectAction=Selecionar ação
ExistingFileNewer2=O arquivo existente é mais novo do que o que o instalador está tentando instalar.
...
ExistingFileNewerOverwriteOrKeepAll=&Fazer isto nos próximos conflitos
