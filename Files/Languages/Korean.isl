...
PrivilegesRequiredOverrideText1=%1은(는) 모든 사용자 (관리자 권한 필요) 또는 현재 사용자용으로 설치합니다.
PrivilegesRequiredOverrideText2=%1은(는) 현재 사용자 또는 모든 사용자 (관리자 권한 필요)용으로 설치합니다.
...
NoUninstallWarning=다음 구성 요소가 컴퓨터에 이미 설치되어 있습니다:%n%n%1%n%n이러한 구성 요소를 선택 해제해도 제거되지 않습니다.%n%n그래도 계속하시겠습니까?
ComponentSize1=%1 KB
ComponentSize2=%1 MB
