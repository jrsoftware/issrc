...
PrivilegesRequiredOverrideText1=%1은(는) 모든 사용자 (관리자 권한 필요) 또는 현재 사용자용으로만 설치합니다.
PrivilegesRequiredOverrideText2=%1은(는) 현재 사용자용으로만 또는 모든 사용자 (관리자 권한 필요)용으로 설치합니다.
...
DiskSpaceWarning=설치 시 최소 %1 KB의 여유 공간이 필요하지만, 선택한 드라이브의 여유 공간은 %2 KB 밖에 없습니다.%n%n그래도 계속하시겠습니까?
...
NoUninstallWarning=설치에서 다음 구성 요소가 컴퓨터에 이미 설치되어 있음을 감지했습니다:%n%n%1%n%n이러한 구성 요소를 선택 해제해도 제거되지 않습니다.%n%n그래도 계속하시겠습니까?
ComponentSize1=%1 KB
ComponentSize2=%1 MB
