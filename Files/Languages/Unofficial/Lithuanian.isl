...
DownloadingLabel=Parsisiunčiami papildomi failai...
...
ErrorFileHash2=Neteisinga failo „hash“ reikšmė: numatyta %1, rasta %2
ErrorProgress=Netinkama eiga: %1 iš %2
ErrorFileSize=Neteisingas failo dydis: numatytas %1, rastas %2

; *** TExtractionWizardPage wizard page and Extract7ZipArchive
ExtractionLabel=Papildomų failų ištraukimas...
ButtonStopExtraction=&Stabdyti ištraukimą
StopExtraction=Ar tikrai norite sustabdyti ištraukimą?
ErrorExtractionAborted=Ištraukimas nutrauktas
ErrorExtractionFailed=Nepavyko ištraukti: %1
...
ExistingFileNewer=Esamas failas yra naujesnis už tą, kurį diegimo programa bando įrašyti. Rekomenduojama palikti esamą failą.%n%nPalikti naujesnį failą?
