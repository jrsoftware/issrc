...
NoUninstallWarning=نصب کننده تشخیص داده است که اجزاء زیر از قبل بر روی کامپیوتر شما نصب شده است:%n%n%1%n%nبرداشتن انتخاب این اجزاء آن‌ها را حذف نمی‌کند.%n%nآیا به هر حال مایل به ادامه هستید؟
