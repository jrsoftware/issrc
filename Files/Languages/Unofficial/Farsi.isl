...
SetupAppRunningError=نصب‌کننده تشخیص داده است که %1 هم‌اکنون در حال اجراست.%n%nلطفاً همه نمونه‌های آن را اکنون ببندید، سپس برای ادامه روی «تأیید» یا برای خروج روی «انصراف» کلیک کنید.
UninstallAppRunningError=حذف‌کننده تشخیص داده است که %1 هم‌اکنون در حال اجراست.%n%nلطفاً همه نمونه‌های آن را اکنون ببندید، سپس برای ادامه روی «تأیید» یا برای خروج روی «انصراف» کلیک کنید.
...
PrivilegesRequiredOverrideText2=%1 را می‌توان فقط برای شما یا برای همه کاربران (نیازمند دسترسی مدیر سیستم) نصب کرد.‏
...
SelectLanguageLabel=زبانی را که می‌خواهید هنگام نصب استفاده شود انتخاب کنید.
...
BrowseDialogLabel=از لیست زیر یک پوشه را انتخاب کرده و سپس بر روی تأیید کلیک کنید.‏
NewFolderName=پوشه جدید

; *** "Welcome" wizard page
WelcomeLabel1=به ویزارد نصب‌کننده [name] خوش آمدید
WelcomeLabel2=این [name/ver] را روی کامپیوتر شما نصب می‌کند.‏%n%nپیشنهاد می‌شود پیش از ادامه، همه برنامه‌های دیگر را ببندید.‏

; *** "Password" wizard page
WizardPassword=گذرواژه
PasswordLabel1=این نصب‌کننده با گذرواژه محافظت شده است.‏
PasswordLabel3=لطفاً گذرواژه را وارد کنید، سپس روی «بعدی» کلیک کنید. گذرواژه‌ها به حروف بزرگ و کوچک حساس هستند.‏
...
InfoBeforeClickLabel=وقتی برای ادامه نصب آماده شدید، روی «بعدی» کلیک کنید.‏
WizardInfoAfter=اطلاعات
InfoAfterLabel=لطفاً اطلاعات مهم زیر را قبل از ادامه مطالعه کنید.‏
InfoAfterClickLabel=وقتی برای ادامه نصب آماده شدید، روی «بعدی» کلیک کنید.‏
...
DiskSpaceWarning=نصب‌کننده برای نصب به حداقل %1 کیلوبایت فضای خالی نیاز دارد، اما درایو انتخاب‌شده فقط %2 کیلوبایت فضای خالی دارد.%n%nآیا می‌خواهید به‌هرحال ادامه دهید؟
DirNameTooLong=نام پوشه یا مسیر بسیار طولانی است.‏
InvalidDirName=نام پوشه صحیح نیست.‏
BadDirName32=نام پوشه‌ها نمی‌تواند شامل کاراکترهای مقابل باشد:%n%n%1
DirExistsTitle=پوشه از قبل وجود دارد
DirExists=این پوشه:%n%n%1%n%nاز قبل وجود دارد. آیا به‌هرحال مایل به نصب در آن پوشه هستید؟
...
SelectComponentsLabel2=اجزایی را که می‌خواهید نصب شوند انتخاب کنید و انتخاب اجزایی را که نمی‌خواهید نصب شوند بردارید. وقتی آماده ادامه بودید، روی «بعدی» کلیک کنید.
...
NoUninstallWarning=نصب‌کننده تشخیص داده است که مؤلفه‌های زیر از قبل روی کامپیوتر شما نصب شده‌اند:%n%n%1%n%nلغو انتخاب این مؤلفه‌ها باعث حذف آن‌ها نمی‌شود.%n%nآیا می‌خواهید به‌هرحال ادامه دهید؟
...
SelectTasksLabel2=وظایف اضافی را که می‌خواهید نصب‌کننده هنگام نصب [name] انجام دهد انتخاب کنید، سپس روی «بعدی» کلیک کنید.‏

; *** "Select Start Menu Folder" wizard page
WizardSelectProgramGroup=انتخاب پوشه منوی استارت
SelectStartMenuFolderDesc=نصب‌کننده در کجا باید میانبرهای برنامه را قرار دهد؟ 
SelectStartMenuFolderLabel3=نصب‌کننده میانبرهای برنامه را در پوشه زیر در منوی استارت ایجاد خواهد کرد.
...
BadGroupName=نام پوشه نباید شامل هر یک از کاراکترهای زیر باشد:%n%n%1
...
ErrorFileSize=اندازه فایل نامعتبر است: %1 انتظار می‌رفت، اما %2 یافت شد
...
PreviousInstallNotCompleted=نصب/حذف برنامه قبلی تکمیل نشده است. شما باید کامپیوتر خود را برای تکمیل عملیات نصب مجدداً راه‌اندازی کنید.%n%nپس از راه‌اندازی مجدد کامپیوتر، نصب‌کننده را مجدداً برای تکمیل عملیات نصب [name] اجرا کنید.
...
ErrorCloseApplications=نصب‌کننده قادر به بستن خودکار تمام اپلیکیشن‌ها نبود. پیشنهاد می‌شود تمام اپلیکیشن‌هایی که از فایل‌هایی که نیاز به به‌روزرسانی توسط نصب‌کننده را دارند را قبل از ادامه ببندید.
PrepareToInstallNeedsRestart=نصب‌کننده باید کامپیوتر را مجدداً راه‌اندازی کند. پس از راه‌اندازی مجدد کامپیوتر، نصب‌کننده را دوباره اجرا کنید تا نصب [name] کامل شود.%n%nآیا می‌خواهید اکنون راه‌اندازی مجدد انجام شود؟
...
FinishedLabel=نصب‌کننده، عملیات نصب [name] بر روی کامپیوتر شما را به پایان رساند. اپلیکیشن می‌تواند با انتخاب میانبرهای نصب شده اجرا شود.
ClickFinish=برای خروج از نصب‌کننده بر روی پایان کلیک کنید.
FinishedRestartLabel=برای تکمیل نصب [name]، نصب‌کننده باید کامپیوتر شما را مجدداً راه‌اندازی کند. آیا می‌خواهید هم‌اکنون راه‌اندازی مجدد انجام شود؟
FinishedRestartMessage=برای تکمیل نصب [name]، نصب‌کننده باید کامپیوتر شما را مجدداً راه‌اندازی کند.%n%nآیا می‌خواهید اکنون راه‌اندازی مجدد انجام شود؟
...
SelectDiskLabel2=لطفاً دیسک %1 را وارد کرده و بر روی تأیید کلیک کنید.%n%nدر صورتی که فایل‌های روی این دیسک در پوشه‌ای غیر از پوشه نمایش داده شده قابل یافتن هستند، مسیر صحیح را وارد کرده و یا بر روی مرور کلیک کنید.
PathLabel=&مسیر:
...
SourceVerificationFailed=اعتبارسنجی فایل منبع ناموفق بود: %1
VerificationSignatureDoesntExist=فایل امضا "%1" وجود ندارد
VerificationSignatureInvalid=فایل امضا "%1" نامعتبر است
VerificationKeyNotFound=فایل امضا "%1" از کلیدی ناشناخته استفاده می‌کند
...
ErrorReadingSource=در هنگام تلاش برای خواندن فایل مبدأ خطایی رخ داده است:
...
UninstalledAndNeedsRestart=برای تکمیل حذف %1 کامپیوتر شما باید مجدداً راه‌اندازی شود.%n%nآیا مایل هستید هم‌اکنون راه‌اندازی مجدد شود؟
UninstallDataCorrupted=فایل «%1» خراب است. حذف امکان‌پذیر نیست

; *** Uninstallation phase messages
ConfirmDeleteSharedFileTitle=حذف فایل اشتراکی؟
ConfirmDeleteSharedFile2=سیستم نشان می‌دهد که فایل اشتراکی زیر دیگر توسط هیچ برنامه‌ای استفاده نمی‌شود. آیا می‌خواهید حذف‌کننده این فایل اشتراکی را حذف کند؟%n%nاگر برنامه‌ای هنوز از این فایل استفاده کند و فایل حذف شود، ممکن است آن برنامه به‌درستی کار نکند. اگر مطمئن نیستید، «خیر» را انتخاب کنید. باقی‌گذاشتن فایل روی سیستم هیچ آسیبی ایجاد نمی‌کند.
...
AdditionalIcons=میانبرهای جانبی:
...
AssocFileExtension=&مرتبط‌کردن %1 با پسوند فایل %2
AssocingFileExtension=در حال مرتبط‌کردن %1 با پسوند فایل %2...
AutoStartProgramGroupDescription=شروع همراه با ویندوز:
AutoStartProgram=شروع خودکار %1
AddonHostProgramNotFound=%1 در پوشه انتخاب شده یافت نشد.%n%nآیا به‌هرحال مایل به ادامه هستید؟
