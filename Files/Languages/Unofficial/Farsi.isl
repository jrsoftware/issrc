...
SelectDiskLabel2=لطفاً دیسک %1 را وارد کرده و بر روی تأیید کلیک کنید.%n%nدر صورتی که فایل‌های روی این دیسک در پوشه‌ای غیر از پوشه نمایش داده شده قابل پیدا شدن است، مسیر صحیح را وارد کرده و یا بر روی مرور کلیک کنید.
PathLabel=&مسیر:
...
ConfirmDeleteSharedFile2=سیستم نشان می‌دهد که فایل اشتراکی زیر دیگر توسط هیچ برvنامه‌ای استفاده نمی‌شود. آیا می‌خواهید حذف‌کننده این فایل اشتراکی را حذف کند؟%n%nاگر برنامه‌ای هنوز از این فایل استفاده کند و فایل حذف شود، ممکن است آن برنامه به‌درستی کار نکند. اگر مطمئن نیستید، «خیر» را انتخاب کنید. باقی‌گذاشتن فایل روی سیستم هیچ آسیبی ایجاد نمی‌کند.
