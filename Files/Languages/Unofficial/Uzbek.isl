...
PowerUserPrivilegesRequired=Ushbu dasturni o‘rnatish uchun siz "Admin" yoki «Опытные пользователи» (Power Users) tarzida kirishingiz kerak.
...
AboutSetupNote=
TranslatorNote=Uzbek translation by Shamsiddinov Zafar // zfrx94@mail.ru
...
BrowseDialogLabel=Ro‘yxatdan jildni tanlang va «ОК»ni bosing.
...
WizardSelectProgramGroup=«Пуск» menyusida jild tanlovi
SelectStartMenuFolderDesc=O‘rnatish dasturi qayerga yorliq hosil qilsin?
SelectStartMenuFolderLabel3=Dastur «Пуск» menyusining quyidagi jildiga yorliq hosil qiladi.
...
NoProgramGroupCheck2=«Пуск» &menyusida jild yaratmaslik
...
ReadyMemoGroup=«Пуск» menyusidagi jild:
...
EntryAbortRetryIgnore=Takroran urinib ko‘rish uchun «Повтор» tugmasini bosing, faylni o‘tkazib yuborish uchun «Пропустить» tugmasini, yoki o‘rnatishni bekor qilish uchun «Отказ» tugmasini bosing.
...
; *** File copying errors
FileAbortRetryIgnore=Takrorlash uchun «Повтор» tugmasini, faylni o‘tkazib yuborish uchun (tavsiya etilmaydi) «Пропустить», yoki  chiqish uchun «Отказ» tugmasini bosing.
FileAbortRetryIgnore2=Takrorlash uchun «Повтор» tugmasini, xatolikni inobatga olmaslik uchun (tavsiya etilmaydi) «Пропустить», yoki  chiqish uchun «Отказ» tugmalaridan birini bosing.
SourceIsCorrupted=Boshlang‘ich fayl shikastlangan
SourceDoesntExist="%1" boshlang‘ich faylni mavjud emas
ExistingFileReadOnly=Mavjud fayl «faqat o‘chish uchun» tarzida belgilangan.%n%n«faqat o‘qish uchun» atributini olib tashlash uchun «Повтор» tugmasini bosing, faylni o‘tkazib yuborish uchun «Пропустить», yoki chiqish uchun «Отказ» tugmasini bosing.
