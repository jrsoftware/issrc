...
InvalidPath=Bạn cần nhập đường dẫn đầy đủ có chữ cái ổ đĩa, ví dụ:%n%nC:\App%n%nhoặc đường dẫn UNC có dạng:%n%n\\server\share
...
DiskSpaceWarning=Trình cài đặt cần ít nhất %1 KB dung lượng trống để cài đặt, nhưng ổ đĩa đã chọn hiện chỉ còn %2 KB.%n%nBạn có vẫn muốn tiếp tục không?
...
SelectComponentsLabel2=Chọn các thành phần bạn muốn cài đặt; bỏ chọn những thành phần bạn không muốn cài đặt. Nhấn 'Tiếp theo' khi bạn đã sẵn sàng tiếp tục.
...
ReadyLabel2a=Nhấn 'Cài đặt' để tiếp tục cài đặt, hoặc nhấn 'Quay lại' nếu bạn muốn xem lại hoặc thay đổi bất kỳ thiết lập nào.
...
PrepareToInstallNeedsRestart=Trình cài đặt phải khởi động lại máy tính của bạn. Sau khi máy tính khởi động lại, hãy chạy lại trình cài đặt để hoàn tất cài đặt [name].%n%nBạn có muốn khởi động lại ngay bây giờ không?
...
FinishedRestartLabel=Để hoàn tất cài đặt [name], trình cài đặt phải khởi động lại máy tính của bạn. Bạn có muốn khởi động lại ngay bây giờ không?
FinishedRestartMessage=Để hoàn tất cài đặt [name], trình cài đặt phải khởi động lại máy tính của bạn.%n%nBạn có muốn khởi động lại ngay bây giờ không?
...
UninstallUnknownEntry=Phát hiện một mục không xác định (%1) trong nhật ký gỡ cài đặt
...
OnlyAdminCanUninstall=Bản cài đặt này chỉ có thể được gỡ cài đặt bởi người dùng có quyền quản trị.
