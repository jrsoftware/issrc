...
SetupFileMissing=Không tìm thấy tệp %1 trong thư mục cài đặt. Vui lòng khắc phục sự cố hoặc tải một bản cài đặt mới.
SetupFileCorrupt=Các tệp cài đặt đã bị hỏng. Vui lòng tải lại một bản cài đặt mới.
SetupFileCorruptOrWrongVer=Các tệp cài đặt đã bị hỏng hoặc không tương thích với phiên bản trình cài đặt này. Vui lòng khắc phục sự cố hoặc tải một bản cài đặt mới.
...
ExitSetupMessage=Quá trình cài đặt chưa hoàn tất. Nếu bạn thoát bây giờ, phần mềm sẽ không được cài vào máy.%n%nBạn có thể mở lại trình cài đặt này vào lúc khác để hoàn tất việc cài đặt.%n%nThoát Cài đặt?
...
WizardSelectTasks=Các tác vụ bổ sung
