...
;
; Changes:
; March 21, 2016 - Changes to current version 5.5.3+
...
; *** SetupLdr messages
SetupLdrStartupMessage=Quessu installerà %1. Vulete cuntinuà ?
...
WindowsVersionNotSupported=Stu prugramma ùn suppurteghja micca a versione di Windows installata nantu à st'urdinatore.
...
OnlyOnTheseArchitectures=Stu prugramma pò solu esse installatu nantu à e versioni di Windows fatte apposta per st'architetture di prucessore :%n%n%1
...
WinVersionTooHighError=Stu prugramma ùn pò micca esse installatu nantu à %1 version %2 o più recente.
...
WelcomeLabel2=Quessu installerà [name/ver] nantu à l'urdinatore.%n%nHè ricumandatu di chjode tutte l'altre appiecazioni nanzu di cuntinuà.
...
NoUninstallWarning=L'Assistente hà vistu chì sti cumpunenti sò dighjà installati nantu à l'urdinatore :%n%n%1%n%nDeselezziunà sti cumpunenti ùn i disinstallerà micca.%n%nVulete cuntinuà quantunque ?
ComponentSize1=%1 Ko
ComponentSize2=%1 Mo
ComponentsDiskSpaceMBLabel=A selezzione currente richiede almenu [mb] Mo di spaziu liberu nantu à u discu.
...
ReadyLabel1=Avà l'Assistente hè prontu à principià l'installazione di [name] nantu à l'urdinatore.
ReadyLabel2a=Sceglie Installà per cuntinuà l'installazione, o nantu à Precedente per rivede o cambià qualchì preferenza.
...
PreparingDesc=L'Assistente appronta l'installazione di [name] nantu à l'urdinatore.
...
InstallingLabel=Ci vole à aspettà mentre l'installazione di [name] nantu à l'urdinatore.

; *** "Setup Completed" wizard page
FinishedHeadingLabel=Fine di l'installazione di [name]
FinishedLabelNoIcons=L'installazione di [name] nantu à l'urdinatore hè compia.
FinishedLabel=L'installazione di [name] nantu à l'urdinatore hè compia. L'appiecazione pò esse lamciata selezziunendu l'accurtatoghji installati.
...
SetupAborted=L'installazione ùn hè micca compia bè.%n%nCi vole à currege u prublemu è eseguisce l'Assistente torna.
...
; *** Registry errors
ErrorRegOpenKey=Errore durante l'apertura di a chjave di registru :%n%1\%2
ErrorRegCreateKey=Errore durante a creazione di a chjave di registru :%n%1\%2
ErrorRegWriteKey=Errore durante a scrittura di a chjave di registru :%n%1\%2

; *** INI errors
ErrorIniEntry=Errore durante a creazione di l'elementu INI in u schedariu "%1".
...
ErrorReadingExistingDest=Un errore s'hè affaccatu pruvendu di leghje u schedariu esistente :
...
ErrorChangingAttr=Un errore s'hè affaccatu pruvendu di cambià l'attributi di u schedariu esistente :
ErrorCreatingTemp=Un errore s'hè affaccatu pruvendu di creà un schedariu in u cartulare di destinazione :
ErrorReadingSource=Un errore s'hè affaccatu pruvendu di leghje u schedariu d'urigine :
ErrorCopying=Un errore s'hè affaccatu pruvendu di cupià un schedariu :
ErrorReplacingExistingFile=Un errore s'hè affaccatu pruvendu di rimpiazzà u schedariu esistente :
ErrorRestartReplace=Fiascu di Rimpiazzamentu di schedariu à u riavviu di l'urdinatore :
ErrorRenamingTemp=Un errore s'hè affaccatu pruvendu di rinumà un schedariu in u cartulare di destinazione :
...
ErrorOpeningReadme=Un errore s'hè affaccatu pruvendu d'apre u schedariu LISEZMOI o README.
...
CreateQuickLaunchIcon=Creà un accurtatoghju nantu à a barra di &Lanciu Prontu
