...
- Help content lives under `ISHelp`; regenerate CHM/Web help whenever editing `ISHelp\*`: run `compile.bat x64 ishelpgen` then `ISHelp\compile.bat` and verify 0 errors.
